					...
					<div class="content-widgets light-gray">
						...
						<div class="control-group" >
								...
								<div style="clear:both;"></div>		
											...
											<input type="Button" class="btn btn-primary" onclick="getXml()"  value="Export Report" />	
											<img src = "<?php echo $this->webroot; ?>app/webroot/images/ajax-loader.gif" id = "load" style = "margin: 10px;float:left;display:none;"/>
...
$.ajax({
	      ...
	      dateType:'html',
	      type:'post',
		  data:'type='+app_type+'&agent_name='+agent_name+'&internal_status='+internal_status+'&external_status='+external_status+'&visa_type='+visa_type+'&app_no='+app_no+'&passport_no='+passport_no+'&psg_name='+psg_name+'&from_date='+from_date+'&to_date='+to_date+'&airline_type='+airline_type+'&oktb_no='+oktb_no+'&doe='+doe+'&pnr_no='+pnr_no,
