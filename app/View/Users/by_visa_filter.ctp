<?php echo $this->Form->input("app_type" ,array('type'=>'hidden','label' => false,'div' => false,'hidden'=>'true','value'=>'visa'))?>
...
<?php echo $this->Form->input("export_type" ,array('type'=>'hidden','label' => false,'div' => false,'hidden'=>'true','value'=>''))?>
<div style="float:left;width:33%;">
								<div class="control-group">
											<label class="control-label"><?php echo __('Application No');?></label>
											<div class="controls">
	...
	<div class="control-group" >
									...
									<div class="control-group" >
											<label class="control-label"><?php echo __('Select Internal Status');?></label>
											<div class="controls">
											<?php if(!isset($internal_status)) $internal_status = array('select'=>'Select'); ?>
												<?php echo $this->Form->input("internal_status" ,array('type'=>'select','label' => false,'div' => false,'class'=>"chzn-select span8",'options'=>$internal_status,'id'=>"internal_status",'data-placeholder'=>"Choose a Internal Status...",'multiple' => true))?>
											<span id = "BalAmt"></span>
											</div>
											
									</div> 
									<div class="control-group">
											<label class="control-label"><?php echo __('Date of Exit');?></label>
											<div class="controls">
												<?php echo $this->Form->input("doe" ,array('label' => false,'readonly'=>'readonly','div' => false,'class'=>"span6",'id'=>"doe"))?>
											</div>
										</div>
										</div>
										<div style="float:left;width:33%">
