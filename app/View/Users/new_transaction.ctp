			...
			<div class="content-widgets light-gray">
						...
						<?php echo $this->Session->flash(); ?>
							...
							<?php echo $this->Form->create('User', array('class'=>'form-horizontal','novalidate'=>'novalidate','enctype'=>'multipart/form-data')); ?>							
								...
								<?php $user_id = $this->UserAuth->getUserId(); echo $this->Form->input("user_id" ,array('value'=>$user_id,'type' => 'hidden', 'label' => false,'div' => false))?>
									...
									<div class="control-group">
										<?php $trans_option = $tr_mode; ?>
											<label class="control-label"><?php echo __('Select User');?></label>
											<div class="controls">
												<?php echo $this->Form->input("user_id" ,array("type"=>"select",'label' => false,'div' => false,'options'=>$user_id)); ?>
											</div>
										</div>
										<?php } ?>	
									...
									<div id = "bank_mode" style = "display:none;float:left;width:45%">	
