...
input[type=text].error,input[type=checkbox].error, .error
{
...
<div class = 'message' style = "display:none;"><span></span> </div>
							...
							echo $this->Form->create('User', array('action' => 'save_visa_app','id'=>'visaform1','class'=>'form-horizontal','novalidate'=>'novalidate', 'enctype'=>'multipart/form-data')); ?>					
		...
		<div class="accordion" id="accordion2">
								...
								<div class="accordion-body collapse <?php if($i == 1) echo 'in'; ?>" id="collapse<?php echo $i; ?>">
									...
									<div class="control-group">
										...
										$attributes = array('legend' => false,'value'=>'male','onchange'=>'spouse_check()'  );?>
									...
									<div style = "float:right;width:50%">	
										...
										<div class="control-group">
											...
											<label class="control-label"><?php echo __('Nationality');?></label>
											<div class="controls">
...
<a href = "javascript:void(0)" onclick = "openAcc(<?php echo $i; ?>)" style="margin-left: 10px;" class="btn btn-primary"><i class="icon-next"></i>Next</a>
										</div>
								</div>
							</div>
								<?php }  ?>	
								...
								<div class="accordion-body collapse " id="collapseTravel">
									<div class="accordion-inner">
										...
										<div class="control-group">
											...
											<div class="controls">
												<?php echo $this->Form->input("city" ,array('label' => false,'div' => false,'onblur'=>"this.value=this.value.toUpperCase()"))?>
											</div>
										</div>
...
<div class="control-group">
		...
		<div class="controls">
		<?php echo $this->Form->input("applicant" ,array("type"=>"text",'label' => false,'div' => false))?>
		</div>
		</div>
</div>
<div style="float:left;width:50%">
...
<div style = "clear:both" ></div>	
 <p>
					 <input type = "checkbox" name = "agree" id = "agree" />&nbsp;&nbsp;Accept the <a href="javascript:void;" onclick = "get_terms()" class='alert-box'>terms and conditions</a> and privacy policy</p>
					 
		
									<button type="submit" style="margin-left: 10px;" class="btn btn-primary"><i class="icon-money"></i> Save & Upload Documents</button>
								</div>
							</div>
						</div>
					</div>
...
minlength:"Please Accept the Terms and Conditions",
},
                    }  
                });
      ...
      var hid_count1 = $('#hid_count1').val();
         	...
         	var ck = 1;
				...
				if(a != 0 && i <= a){ id = '-A'+ak; ak++;}
					...
					$("#UserSpouseName"+id).rules("add", "required");
