		...
		<div class="row-fluid">
				<div class="span12">
					<div class="content-widgets gray">
						...
						<?php echo $this->Form->create('User',array('action' => 'user_roles','id'=>'user_roles','class'=>'form-horizontal','novalidate'=>'novalidate'));  ?>
								...
								<?php if(!isset($visa)) $visa = 0 ;
								if(!isset($oktb)) $oktb = 0 ;
								...
								<div style = "width:48%; float:left;" >
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php echo $this->Form->input("name" ,array('label' => false,'class'=>"span8",'div' => false,'id'=>"name"))?>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php echo $this->Form->input("emailId" ,array('label' => false,'div' => false,'class'=>"span8",'id'=>"emailIid"))?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php echo $this->Form->input("contact_no" ,array('label' => false,'div' => false,'class'=>"span8",'id'=>"contact_no"))?>
										</div>
									</div>
								...
								<div style = "width:48%; float:left;" >
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php echo $this->Form->input("username" ,array('label' => false,'div' => false,'class'=>"span8",'id'=>"username"))?>
											<?php if(isset($userMsg)) { ?><div class="error-message"><?php echo $userMsg; ?></div><?php } ?>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php echo $this->Form->input("password" ,array('label' => false,'div' => false,'class'=>"span8",'id'=>"UserPassword"))?>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<?php echo $this->Form->input("cpassword" ,array('type'=>'password','label' => false,'div' => false,'class'=>"span8",'id'=>"cpassword"))?>
										</div>
									</div>
									...
									<div class="control-group" id = 'oktbDisp' <?php if(isset($oktb_select) && $oktb_select == 0) { ?> style = "display:none;" <?php } ?>>
										...
										<div class="controls">
											<?php echo $this->Form->input("oktb_airline" ,array('type'=>'select','label' => false,'div' => false,'class'=>"chzn-select span8",'options'=>$airline,'id'=>"oktb_airline",'data-placeholder'=>"Choose OKTB Airline...",'multiple' => true))?>
										</div>
									</div>
