					...
					<div class="content-widgets light-gray">
						...
						<?php echo $this->Session->flash(); 
							...
							echo $this->Form->create('User', array('id'=>'visaform','class'=>'form-horizontal','novalidate'=>'novalidate', 'enctype'=>'multipart/form-data')); ?>					
									...
									<input type = 'hidden' name = 'show' value = '<?php if(isset($show)) echo $show; ?>' id= 'show'/>
						...
						<div style="float:left;width:50%;">
									<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
												<?php echo $this->Form->input("destination" ,array('type'=>'select','label' => false,'div' => false,'options'=>$city_option,'onblur'=>"this.value=this.value.toUpperCase()"))?>
											</div>
										</div>
										
										<div class="control-group">		
										<?php  $acount[0] = 'Adult(s)'; for($i=1;$i<=9;$i++) $acount[$i] = $i; ?>				
...
document.getElementById("UserDestination").setAttribute("disabled");
		...
		$('#submit').html("<b>Loading </b><img src = '<?php echo $this->webroot; ?>app/webroot/images/loader.gif' > ");
							 	$.ajax({
						      url: "<?php echo $this->webroot; ?>/get_data",
						      dateType:'html',
						      type:'post',
						     data:$('#visaform').serialize(),
