...
<input name="passport<?php echo $i;?>" type="file" id="my_file_one<?php echo $i;?>" onchange="showName(this.id)" style="visibility:hidden;" /><div id="customfileupload_one<?php echo $i;?>"  onclick="Getfile(this.id)" name="fileupload1">Select a file</div>
