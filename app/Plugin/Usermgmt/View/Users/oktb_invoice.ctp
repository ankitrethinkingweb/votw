...
<td style = "width:34%;">
<p ><span style= "font-weight:bold;">Invoice No.</span> : <?php  if(isset($oktb[$oktb_id[0]][$oktb_id[0]]['oktb_id'])) echo $oktb[$oktb_id[0]][$oktb_id[0]]['oktb_id'];?></p>
<p style="margin-left: 85px;">: </p>
<p ><span style= "font-weight:bold;">Reference</span> <span style = "margin-left:12px;">:</span> <?php if(isset($oktb_id[0])) echo $oktb_id[0];?> </p>
<p style="margin-left: 85px;">: </p>
</td>
<td style = "width:24%;">
...
<td style="width:5%;">&nbsp;</td>
<td style="width:2%;">|</td>
<td style="width:70%;">OK TO BOARD</td>
<td style="width:2%;">|</td>
<td style="width:20%;">&nbsp;</td>
</tr>
<?php if(isset($oktb) && count($oktb) > 0){ foreach($oktb as $k=>$a){  ?>
<tr >
<td style="width:5%;padding-top:7px;">&nbsp;</td>
<td style="width:2%;padding-top:7px;">|</td>
<td style="width:70%;padding-top:7px;"><?php if(isset($a[$k]['oktb_name'])){ echo $a[$k]['oktb_name']; if(isset($a[$k]['oktb_passportno'])) echo ' / '.$a[$k]['oktb_passportno']; }?></td>
<td style="width:2%;padding-top:7px;">|</td>
<td style="width:20%;padding-top:7px;text-align:right;"><?php if(isset($amt)) echo $amt; echo '.00';  ?></td>
</tr>
<?php } }?>
...
<td style="width:5%;padding-top:7px;">&nbsp;</td>
<td style="width:2%;padding-top:7px;">|</td>
<td style="width:70%;padding-top:7px;"><?php if(isset($airline)) echo '( '.$airline.' )'; ?></td>
<td style="width:2%;padding-top:7px;">|</td>
...
<tr >
<td style="width:78%;font-weight:bold;"><?php if(isset($fee_in_words) && strlen($fee_in_words) > 0){ if(isset($curr) && strlen($curr) > 0) echo $curr; else echo ' INR'; echo ' '.$fee_in_words;  }else echo "&nbsp;"; ?></td>
<td style="width:2%;">|</td>
<td style="width:20%;font-weight:bold;text-align:right;"><?php if(isset($curr) && strlen($curr) > 0) echo $curr.' '; else echo 'INR '; if(isset($fee) && strlen($fee) > 0) echo $fee; else echo 0;  ?></td>
</tr>
<tr>
