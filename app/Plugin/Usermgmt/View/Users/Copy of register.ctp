						...
						<div class="widget-container gray ">
							...
							<?php echo $this->Form->create('User', array('action' => 'register','class'=>'form-horizontal','novalidate'=>'novalidate')); ?>					
									...
									<fieldset title="Step 1">
										...
										<?php $option = $agentType; //print_r($agentType); ?>
											<label class="control-label"><?php echo __('Agent Type');?></label>
											<div class="controls">
												<?php echo $this->Form->input("agent_type" ,array('type' => 'select', 'label' => false,'div' => false,'options'=>$option ))?>
											</div>
										</div>
									...
									<div style = "float:left;width:45%">	
										...
										<div class="control-group">
											<label class="control-label"><?php echo __('Website');?></label>
											<div class="controls">
									...
									<fieldset title="Step 3">
										<legend>ContactPerson Details</legend>
