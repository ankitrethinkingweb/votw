<div class="row-fluid">
				<div class="span12">
					<div class="content-widgets gray">
						...
						<?php echo $this->Form->create('UserGroup',array('class'=>'form-horizontal','novalidate'=>'novalidate')); ?>
						<?php echo $this->Form->hidden('id');?>
							...
							<div class="control-group">
								...
								<div class="form-actions">
									<button type="submit" class="btn btn-info"><i class="icon-upload-alt"></i>Update Group</button>
